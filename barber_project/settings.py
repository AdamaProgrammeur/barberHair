...
SECRET_KEY = 'django-insecure-@8u!ua+7qkghfv@(w8(9+#o87cv_oj_he$2cs!lq+a!5homshv'
...
# barber_project/settings.py

CSRF_TRUSTED_ORIGINS = [
    'http://unideating-sebrina-nonbindingly.ngrok-free.dev',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'barbershop.context_processors.salon_settings',  # <-- ajouter ici
            ],
        },
    },
]
